...
\begin{frame}
    \justifying
    \hspace{0.5cm}Fotos oculus
\end{frame}

\begin{frame}
    \justifying
    \hspace{0.5cm}Fotos FWA
\end{frame}
...
\begin{frame}{Implementação e Configurações}
    \begin{figure}
        \centering
        \includegraphics[width=1\linewidth]{etc/simu/arquitetura.png}
...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=1\linewidth]{etc/simu/delay.png}
